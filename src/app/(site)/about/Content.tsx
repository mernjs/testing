...
const items = [
  ...
  // Hidden from navigation/listing per request — page still lives at /about/co-founder-coo.
  // { title: "Co-Founder & COO", subtitle: brandify("Meet the leader behind YashOrbit."), description: "Get to know the vision, philosophy, and journey of our Co-Founder & COO, and what drives our long-term strategy as a company.", href: "/about/co-founder-coo", icon: Briefcase, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1200&auto=format&fit=crop", highlights: ["Founder Insights", "Leadership Vision", "Direct Access"] },
