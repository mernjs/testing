...
import { Users, Users2, Newspaper, Compass, Trophy, ShieldCheck, Target, Layers, Scale, ReceiptText, ShieldAlert } from "lucide-react";
...
const items = [
  ...
  { title: "Our Team", subtitle: "The minds behind the technology.", description: "We are a diverse group of engineers, designers, and strategists united by a passion for building exceptional digital experiences.", href: "/about/our-team", icon: Users, image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=1200&auto=format&fit=crop", highlights: ["21 Specialists", "Senior-Led Team", "Remote-first"] },
  { title: "Founders & Leadership", subtitle: brandify("The people leading YashOrbit."), description: "Meet our co-founders and executive team — the vision, philosophy, and leadership driving our strategy, operations, technology, finance, and people.", href: "/about/leadership", icon: Users2, image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=1200&auto=format&fit=crop", highlights: ["2 Co-Founders", "5-person Leadership Team", "Direct Access"] },
