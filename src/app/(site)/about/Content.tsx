...
import { Users, Newspaper, Compass, Trophy, ShieldCheck, Target, Layers, Scale, ReceiptText, ShieldAlert } from "lucide-react";
...
const items = [
  ...
  { title: "Blog", subtitle: "Engineering-led insights from our team.", description: "Practical write-ups on web, mobile and AI development — architecture decisions, delivery lessons and technology trends from the people building with them every day.", href: "/blog", icon: Newspaper, image: "https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=1200&auto=format&fit=crop", highlights: [`${blogPosts.length} Articles`, "Engineering-led", "Web · Mobile · AI"] },
  { title: "Privacy Policy", hidden: true, subtitle: "Your data, secured and respected.", description: "We take your privacy seriously. This policy outlines exactly how we collect, use, and protect your information in compliance with global standards.", href: "/about/privacy-policy", icon: ShieldCheck, image: "https://images.unsplash.com/photo-1633265486064-086b219458ec?q=80&w=1200&auto=format&fit=crop", highlights: ["Transparent Policy", "Secure by Design", "GDPR Aware"] },
  { title: "Terms & Conditions", hidden: true, subtitle: "The ground rules for using our site.", description: "These Terms govern your access to and use of our website — eligibility, intellectual property, accounts, payment, warranties, and liability.", href: "/about/terms-and-conditions", icon: Scale, image: "https://images.unsplash.com/photo-1589391886645-d51941baf7fb?q=80&w=1200&auto=format&fit=crop", highlights: ["Clear Terms", "IP Protected", "India-governed"] },
  { title: "Refund & Cancellation Policy", hidden: true, subtitle: "Fair terms if plans change.", description: "How and when you can cancel an engagement with us, and what refund, if any, applies — for development projects, training programs, and direct purchases.", href: "/about/refund-cancellation-policy", icon: ReceiptText, image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1200&auto=format&fit=crop", highlights: ["Milestone-based", "Pro-rata Refunds", "15-day Processing"] },
  { title: "Acceptable Use Policy", hidden: true, subtitle: "Keeping our systems safe for everyone.", description: "The rules for using our website and systems — prohibited activities, security responsibilities, and how to responsibly report a vulnerability.", href: "/about/acceptable-use-policy", icon: ShieldAlert, image: "https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&w=1200&auto=format&fit=crop", highlights: ["Fair Use", "Responsible Disclosure", "IT Act Aligned"] },
];

// Cards marked `hidden` (policy pages) are kept in code but not listed.
const [featured, ...rest] = items.filter((item) => !("hidden" in item && item.hidden));
      ...
      <section className="py-24 sm:py-32 bg-background relative">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-3 mb-10">
            <h2 className="text-sm font-bold uppercase tracking-wider text-muted-foreground">More About Us</h2>
