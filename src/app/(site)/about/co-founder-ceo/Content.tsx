...
export default function CoFounderCeoContent() {
  return (
    <ExecutiveProfile
      ...
      overviewDescription="How Yashita Singh approaches leading the company."
      overviewItems={[
      ...
      achievementsDescription={brandify("A few of the milestones Yashita Singh has led YashOrbit through.")}
      achievements={[
      ...
      ctaDescription="For complex or high-stakes engagements, we're glad to bring Yashita Singh directly into the conversation."
    />
  );
}
