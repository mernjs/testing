    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <FAQAccordion
        faqs={[
          ...
          { question: brandify("What's Aditya's background before founding YashOrbit?"), answer: brandify("He spent over a decade as a backend engineer at two mid-sized software companies before founding YashOrbit in 2026.") },
