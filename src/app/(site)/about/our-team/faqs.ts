export const ourTeamFaqs: { question: string; answer: string }[] = [
  { question: "Is YashOrbit fully remote, or do you have offices?", answer: "We operate as a distributed, remote-first team spanning multiple timezones, with occasional in-person gatherings for team collaboration." },
  ...
  { question: "Do you offer internships or entry-level roles?", answer: "Our hiring is primarily focused on experienced engineers, though we do offer select opportunities through our Training programs for emerging talent." },
