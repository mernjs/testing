...
export const teamMembers: { name: string; role: string; department: Department; description: string; gender: Gender; href?: string }[] = [
  ...
  { name: "Vinit Singh", role: "Chief Technology Officer", department: "Leadership", description: "Leads engineering strategy, architecture standards, and the company's applied AI roadmap.", gender: "male", href: "/about/cto" },
  { name: "Suman Singh", role: "Chief Financial Officer", department: "Leadership", description: "Owns financial planning, statutory compliance, and pricing strategy across the company.", gender: "female", href: "/about/cfo" },
  { name: "Yogita Singh", role: "Chief Human Resources Officer", department: "Leadership", description: "Owns talent acquisition, culture, and learning and development as the team grows.", gender: "female", href: "/about/chro" },
