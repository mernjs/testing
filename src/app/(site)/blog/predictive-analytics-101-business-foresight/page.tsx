...
import PredictiveAnalyticsContent from "./Content";
...
export const generateMetadata = () => withSeoOverrides("/blog/predictive-analytics-101-business-foresight", baseMetadata);
