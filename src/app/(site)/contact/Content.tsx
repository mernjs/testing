              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4 p-6 rounded-2xl bg-muted/30 border border-border/50 hover:bg-muted/50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground"><span className="font-semibold"><span className="text-foreground">Yash</span><span className="text-primary">Orbit</span></span> Technologies<br/>No 163, MM Colony, A Block, Aminjikarai,<br/> Chennai, Tamil Nadu 600029<br/>India</p>
                  </div>
                </div>
              </div>
            </motion.div>
