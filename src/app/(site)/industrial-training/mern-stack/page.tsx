...
export const generateMetadata = () => withSeoOverrides("/industrial-training/mern-stack", baseMetadata);
...
export default function MernStackTrainingPage() {
  const jsonLd = [
    courseJsonLd({
      ...
      path,
      duration: "P6W",
      credential: "MERN Stack Industrial Training Certificate of Completion",
    }),
    breadcrumbJsonLd([
      { name: "Home", path: "/" },
