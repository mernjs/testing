...
const path = "/resource-augmentation/package-based-team";
...
export const generateMetadata = () => withSeoOverrides("/resource-augmentation/package-based-team", baseMetadata);
