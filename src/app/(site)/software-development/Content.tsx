...
import { Code2, Globe, Smartphone, Monitor, LineChart, Bot, Cpu, Eye, Glasses } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen selection:bg-primary/30 overflow-hidden">
      <ListingHero
        ...
        description="From custom web and mobile applications to desktop platforms and bespoke AI integrations — explore our software engineering capabilities designed to accelerate digital growth and scale effortlessly."
        icon={Code2}
