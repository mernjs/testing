...
import { DOCUMENT_MODULES, documentModuleLabel } from "@/lib/admin/documents-shared";
    ...
    <>
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <Input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} placeholder="Title, filename, or category" className="h-8 w-64 pl-8" />
        </div>
      </div>
      <div className="flex flex-col gap-1.5">
