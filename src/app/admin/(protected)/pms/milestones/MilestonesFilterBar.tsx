...
export default function MilestonesFilterBar({
  initialSearch,
  initialStatus,
}: {
    ...
    <>
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <Input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} placeholder="Name or description" className="h-9 w-56 pl-8 rounded-xl border-border/50 bg-background focus-visible:border-primary focus-visible:ring-primary/40" />
        </div>
      </div>
      <div className="flex flex-col gap-1.5">
