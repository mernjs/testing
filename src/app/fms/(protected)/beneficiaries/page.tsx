      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/60 pb-3">
        ...
        <form className="relative min-w-[240px]">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border/60 bg-background pl-8 pr-3 py-1.5 text-xs text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
          />
        </form>
      </div>
