    ...
    <div className="flex min-h-screen">
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/20 p-10 lg:flex">
        ...
        <div className="relative z-10 flex items-center gap-2 text-lg font-bold">
          ...
          {brandify("YashOrbit")} <span className="text-foreground">LMS</span>
        </div>

        <div className="relative z-10 max-w-md">
          <h1 className="text-4xl font-black tracking-tight text-foreground">
            Manage every lead,{" "}
            <span className="bg-gradient-to-r from-primary to-yashorbit-coral bg-clip-text text-transparent">in one place.</span>
          </h1>
        ...
        <p className="relative z-10 text-xs text-muted-foreground">Private lmsUser area — not indexed, not public.</p>
      </div>
