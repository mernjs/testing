...
import { CalendarDays, CircleDollarSign, Layers, Building2 } from "lucide-react";
...
export default async function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [client, members, employees, activity, manager] = await Promise.all([
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <GlassCard className="lg:col-span-2">
          ...
          <CardContent>
            <ProjectProgressControl projectId={id} progressPercent={project.progressPercent} editable={canManage} />
          </CardContent>
        </GlassCard>
      </div>
