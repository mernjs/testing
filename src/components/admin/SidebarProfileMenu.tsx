...
/** No "name" field exists on admin accounts — derive a real, non-fabricated
 * display name from the email's local-part rather than inventing one. */
      ...
      <Sheet open={profileOpen} onOpenChange={setProfileOpen}>
        <SheetContent>
          <SheetHeader className="border-b border-border/60">
            ...
            <SheetDescription>Account details for this admin session.</SheetDescription>
          </SheetHeader>
          <div className="flex-1 space-y-6 overflow-y-auto p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-sm text-muted-foreground">{adminEmail}</p>
              </div>
            </div>
