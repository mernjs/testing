...
import { changeAibotsPasswordAction, type ChangePasswordState } from "@/app/aibots/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeAibotsPasswordAction, initial);
