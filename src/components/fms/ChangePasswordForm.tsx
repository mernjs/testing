...
import { changeFmsPasswordAction, type ChangePasswordState } from "@/app/fms/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeFmsPasswordAction, initial);
