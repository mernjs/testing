...
import { changeHubPasswordAction, type ChangePasswordState } from "@/app/workspace/change-password/actions";

const initial: ChangePasswordState = {};

export default function HubChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeHubPasswordAction, initial);
