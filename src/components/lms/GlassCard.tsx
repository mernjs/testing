...
/**
 * The one card surface for the whole LMS panel — matches the public
...
export default function GlassCard({
  ...
  return (
    <div className="group/gcard relative h-full">
      <Card
        className={cn(
          "lms-surface relative h-full rounded-3xl border border-border/40 bg-background/95 shadow-none backdrop-blur-md transition-all duration-300 ease-out",
          "dark:bg-card/85",
