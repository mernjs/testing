...
import { changeMessengerPasswordAction, type ChangePasswordState } from "@/app/messenger/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeMessengerPasswordAction, initial);
