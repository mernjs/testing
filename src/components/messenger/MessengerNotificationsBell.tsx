...
import { markNotificationsReadAction, markAllNotificationsReadAction } from "@/app/messenger/(protected)/actions";
...
export default function MessengerNotificationsBell({ items, unread }: { items: BellItem[]; unread: number }) {
