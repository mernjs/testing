...
import { changeOtsPasswordAction, type ChangePasswordState } from "@/app/ots/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeOtsPasswordAction, initial);
