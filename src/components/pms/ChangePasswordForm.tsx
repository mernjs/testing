...
import { changePmsPasswordAction, type ChangePasswordState } from "@/app/pms/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changePmsPasswordAction, initial);
