...
import { changePortalPasswordAction, type ChangePasswordState } from "@/app/portal/change-password/actions";
    ...
    <div className="w-full max-w-sm">
      <GlassCard>
        <CardHeader>
          ...
          <CardDescription>
            {forced ? "Your account was set up with a temporary password. Choose your own to continue." : "Minimum 8 characters."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form action={formAction} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input id={nextId} name="next" type={show ? "text" : "password"} required minLength={8} autoComplete="new-password" className="pr-9" />
                <Button
                  type="button"
                  variant="ghost"
                  size="icon-xs"
