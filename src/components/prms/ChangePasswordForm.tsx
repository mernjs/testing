...
import { changePrmsPasswordAction, type ChangePasswordState } from "@/app/prms/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changePrmsPasswordAction, initial);
