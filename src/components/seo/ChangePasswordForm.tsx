...
import { changeSeoPasswordAction, type ChangePasswordState } from "@/app/seo/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeSeoPasswordAction, initial);
