...
import { changeSmmsPasswordAction, type ChangePasswordState } from "@/app/smms/change-password/actions";

const initial: ChangePasswordState = {};

export default function ChangePasswordForm({ forced }: { forced: boolean }) {
  const [state, formAction, pending] = useActionState(changeSmmsPasswordAction, initial);
