...
export default function SopSidebarShell({
  email,
  roles,
  flags,
  createdAt,
  ...
  return (
    <motion.aside
      ...
      className="lms-surface sop-print-hide hidden shrink-0 flex-col overflow-hidden rounded-3xl border border-border/40 bg-background/95 shadow-none backdrop-blur-md md:flex dark:bg-card/85"
    >
      <div
        className={cn(
