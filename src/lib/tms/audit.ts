...
/**
 * Append-only audit trail for every TMS mutation. Never updated or deleted.
 * Mirrors `src/lib/pms/activity.ts`.
 */

export const AUDIT_LOGS_COLLECTION = "training_audit_logs";
...
export interface AuditLog {
  ...
  /** Free-form summary of what changed, e.g. "status: draft → active". */
  summary: string | null;
